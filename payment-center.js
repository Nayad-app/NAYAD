...
(function(){
  ...
  window.showInvoiceDetails=async function(invoiceId){
    ...
    open(`<h2>Падааны дэлгэрэнгүй</h2>
      ...
      ${status==='confirmed'?`<p class="sub">Падааны мэдээллийг хүссэн үедээ засна. Өмнө бүртгэсэн төлбөр өөрчлөгдөхгүй.</p><button class="primary full" onclick="window.editConfirmedInvoice('${esc(invoice.id)}')">✎ Падаан засах</button>`:`<div class="agreementWarning"><b>Засах боломжгүй</b><span>Цуцалсан падааныг засах боломжгүй.</span></div>`}

...
(function(){
  ...
  .profileMenuHeader{display:flex;align-items:center;justify-content:space-between;margin-bottom:21px}.profileMenuHeader b{font-size:21px;font-weight:900;letter-spacing:-.5px}

...
function injectCloudRuntimeBeforeCloudModules(html){
  ...
  const invoiceTag='<script src="./invoice-cloud.js?v=76"></script>';
...
function patchDocument(html){
  ...
  patched=patched.replace(/\.\/contact-types\.js\?v=\d+/g,"./contact-types.js?v=14");
  ...
  patched=injectScriptBefore(patched,"./supplier-cloud.js?v=61","./contact-types.js?v=14");

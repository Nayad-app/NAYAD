...
function patchDocument(html){
  ...
  patched=patched.replace(/\.\/profile-menu\.js\?v=\d+/g,"./profile-menu.js?v=2");
  ...
  patched=injectScriptAfter(patched,"./share.js?v=39","./profile-menu.js?v=2");

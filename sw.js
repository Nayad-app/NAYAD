...
function injectCloudRuntimeBeforeCloudModules(html){
  ...
  const invoiceTag='<script src="./invoice-cloud.js?v=56"></script>';
...
function patchDocument(html){
  ...
  patched=patched.replace(/\.\/invoice-cloud\.js\?v=\d+/g,"./invoice-cloud.js?v=56");

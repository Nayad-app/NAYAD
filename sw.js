const CACHE = "nayad-v39";

const ASSETS = ["./","./manifest.webmanifest","./icon-180.png","./icon-192.png","./icon-512.png","./oauth-fix.js?v=39","./render.js","./app-state.js?v=37","./store-switcher.js?v=39","./share.js?v=37","./invoice-cloud.js?v=37","./supplier-cloud.js?v=37","./company-label.js"];
  ...
  if (request.mode === "navigate" || request.destination === "document") {
    event.respondWith(fetch(request,{cache:"no-store"}).then(async response => {
      try {
        ...
        if(!patched.includes("oauth-fix.js")) patched=patched.replace(/<\/body>/i,'<script src="./oauth-fix.js?v=39"></script></body>');
        ...
        if(!patched.includes("store-switcher.js")) patched=patched.replace(/<\/body>/i,'<script src="./store-switcher.js?v=39"></script></body>');

const CACHE = "nayad-v31";

const ASSETS = ["./","./manifest.webmanifest","./icon-180.png","./icon-192.png","./icon-512.png","./oauth-fix.js","./render.js","./share.js","./invoice-cloud.js?v=31","./supplier-cloud.js?v=31","./company-label.js"];

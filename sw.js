// Invalidate the installed app shell for the direct invoice contact dropdown.
const CACHE = "nayad-v124";
...
function injectCloudRuntimeBeforeCloudModules(html){
  ...
  const invoiceTag='<script src="./invoice-cloud.js?v=73"></script>';
...
function patchDocument(html){
  ...
  patched=patched.replace(/\.\/invoice-cloud\.js\?v=\d+/g,"./invoice-cloud.js?v=73");
  ...
  patched=injectScriptBefore(patched,"./invoice-cloud.js?v=73","./money-input.js?v=1");
  ...
  patched=injectScriptAfter(patched,"./invoice-cloud.js?v=73","./payment-center.js?v=10");

...
assert.match(swSource,/const CACHE = "nayad-v96";/,'contact type UI must invalidate the installed app shell');
...
assert.match(swSource,/\.\/contact-types\.js\?v=1/);
assert.match(indexSource,/\.\/contact-types\.js\?v=1/,'index and service worker must load the contact type module');

...
assert.match(swSource,/const CACHE = "nayad-v102";/,'home debt sorting must invalidate the installed app shell');
...
assert.match(swSource,/\.\/contact-types\.js\?v=5/);
assert.match(indexSource,/\.\/contact-types\.js\?v=5/,'index and service worker must load the contact type module');

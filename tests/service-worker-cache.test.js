...
assert.match(swSource,/const CACHE = "nayad-v91";/,'business profile flow must invalidate the installed app shell');
...
assert.match(swSource,/\.\/payment-center\.js\?v=6/);
assert.match(indexSource,/\.\/payment-center\.js\?v=6/,'index and service worker must load the same payment center');

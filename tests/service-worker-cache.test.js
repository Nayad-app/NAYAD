...
assert.match(swSource,/const CACHE = "nayad-v98";/,'modal backdrop fix must invalidate the installed app shell');
...
assert.match(swSource,/\.\/contact-types\.js\?v=2/);
assert.match(indexSource,/\.\/contact-types\.js\?v=2/,'index and service worker must load the contact type module');

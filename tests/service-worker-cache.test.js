...
assert.match(swSource,/const CACHE = "nayad-v103";/,'compact contact list must invalidate the installed app shell');
...
assert.match(swSource,/\.\/contact-types\.js\?v=6/);
assert.match(indexSource,/\.\/contact-types\.js\?v=6/,'index and service worker must load the contact type module');
